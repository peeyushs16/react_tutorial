...
<div className="d-flex">
                    <div className='rounded mx-2' style={{height:'30px',width:'30px'}}>
                        <input type="color" className='rounded' style={{height:'30px',width:'30px'}} id="colorpicker" onChange={props.handleColor}></input>
                    </div></div>
                </div>
            </div>
        </nav>
